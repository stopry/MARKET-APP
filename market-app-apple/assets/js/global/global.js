...
function backGame(){
    if(localStorage.getItem('isInstall')){//打开本地appZ家园
        var scheme = "com.zjiayuan.game";//Z家园的URLScheme
        var result = uexWidget.loadApp(scheme);
        if(!result){
...
appcan.ready(function(){
    ...
    appCanIsReady = true;
    var iosPadding = "<div class='iosSys'></div>";
    var iosStatusBar = "<div class='iosStatusBar'></div>"
   
    $(".iosSys").remove();
    $("body").prepend(iosPadding);
    $("body").prepend(iosStatusBar);
