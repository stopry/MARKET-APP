$(function () {
    ...
    function autoHeightChart() {
        ...
        if(showBuySale){
            chartH = h-(selTreeH+baseInfoH+buySaleH+changeCahrtTableH+oprBtnWrapH+footerH)-70-barH;
            // console.log(1);
        }else{
            chartH = h-(selTreeH+baseInfoH+changeCahrtTableH+oprBtnWrapH+footerH)-70-barH;
            // console.log(2)
            // chartH =50;
        }
